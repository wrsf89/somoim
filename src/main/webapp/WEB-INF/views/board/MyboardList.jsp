...
<style>
 ...
 <div class="what-we-do we-padding">
	<div class="section-top-border">
				<h1 class="mb-30" style="text-align:center">내가 만든 모임</h1>
				<div class="progress-table-wrap" style="margin-left:17%; margin-right:17%; padding:auto;">
					<div class="progress-table">
						<div class="table-head" style="text-align:center">
							...
							<div class="visit"><p>회원수</p></div>
							<div class="visit"><p>신청대기수</p></div>
						</div>
						...
						<div class="table-row">
							...
							<div class="visit"><p>${bList.b_people }</p></div>
							<div class="visit"><a class="aTitle" href="myboardApply?a_bcode=${bList.b_code }"><p>${bList.b_apeople }</p></a></div>
						</div>
						</c:forEach>
					</div>
				</div>
