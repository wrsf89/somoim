				...
				<div class="progress-table-wrap" style="margin-left:17%; margin-right:17%; padding:auto;">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="visit"><p>${bList.b_people }</p></div>
							<div class="visit"><p><button class="Categorybtn genric-btn primary circle arrow" onclick="location.href='applydelete?a_bcode=${bList.b_code}'">삭제</button></p></div>
						</div>
						</c:forEach>
					</div>
				</div>
